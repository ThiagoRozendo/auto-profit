...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Acesse sua conta AutoProfit e gerencie sua revenda de veículos." },
    ],
  }),
  component: LoginPage,
});
  ...
  return (
    <div className="grid min-h-screen lg:grid-cols-2">
      ...
      <div className="relative hidden flex-col justify-between overflow-hidden p-12 lg:flex">
        ...
        <div className="text-primary-foreground">
          ...
          <div className="mt-10 grid max-w-md grid-cols-3 gap-4">
            {[
              ...
              <div key={s.v} className="rounded-xl border border-primary-foreground/20 bg-background/10 p-3 backdrop-blur">
        ...
        <p className="text-xs text-primary-foreground/80">© 2025 AutoProfit. Todos os direitos reservados.</p>
      </div>
          ...
          >
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="email" type="email" placeholder="voce@empresa.com" className="pl-9"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="pwd" type="password" placeholder="••••••••" className="pl-9"
